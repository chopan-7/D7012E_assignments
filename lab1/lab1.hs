...
findSubRange :: Int -> Int -> [a] -> [(Int, Int)]
...
minSize :: (Int, Int) -> (Int, Int) -> [Integer] -> (Int, Int)
...
getMin :: (Int, Int) -> [(Int, Int)] -> [Integer] -> (Int, Int)
...
getKSmallest :: Int -> [(Int,Int)]  -> [Integer] -> [(Int, Int)]
...
formatPrintLines :: [(Int, Int)] -> [Integer] -> IO ()
